      ...
      child: Scaffold(
        ...
        body: Center(
          child: ElevatedButton(
            onPressed: () => Navigator.push(context,MaterialPageRoute(builder: (ctx) => FutureDemoPage(),
              ),
            ),
            child: Text('Demonstrate FutureBuilder', style: GoogleFonts.poppins(fontSize:18.0),),
          ),
        ),
      ),
    );
